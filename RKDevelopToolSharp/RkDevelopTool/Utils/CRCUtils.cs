namespace RkDevelopTool.Utils
{
    public static class CRCUtils
    {
        ...
        private static readonly ushort[] crc16_table = new ushort[256]
        {
            ...
            0x36b3, 0x2692, 0x16f1, 0x06d0, 0x7637, 0x6616, 0x5675, 0x4654,
            0xb7bb, 0xa79a, 0x97f9, 0x87d8, 0xf73f, 0xe71e, 0xd77d, 0xc75c,
        ...
        private static readonly uint[] gTable_Crc32 = new uint[256]
        {
        ...
        private static readonly uint[] crc32table_le = new uint[256]
        {
        ...
        public static ushort CRC_16(ReadOnlySpan<byte> aData)
        {
            ushort crc = 0;
        ...
        public static void P_RC4(Span<byte> buf)
        {
            byte[] S = new byte[256];
            byte[] K = new byte[256];
            byte temp;
        ...
        public static uint crc32_le(uint crc, ReadOnlySpan<byte> p)
        {
            crc ^= 0xFFFFFFFF;
            foreach (byte b in p)
            {
                crc = (crc >> 8) ^ crc32table_le[(crc ^ b) & 0xFF];
            }
